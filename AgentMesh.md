...
- **想看任务目录（Task Directory）与可复盘产物（Artifacts）规范**
  - [`docs/agentmesh/artifacts.md`](docs/agentmesh/artifacts.md)
...
- **想落地可信执行：Controller 状态机 / gates / evidence**
  - [`docs/agentmesh/implementation.md`](docs/agentmesh/implementation.md)
...
- **想接入 Codex（exec worker / app-server）**
  - [`docs/agentmesh/adapters/codex.md`](docs/agentmesh/adapters/codex.md)
...
- **想做 GUI（Artifacts-first + Codex Chat）**
  ...
  - [`docs/implementation-notes/agentmesh-gui-codex-style/README.md`](docs/implementation-notes/agentmesh-gui-codex-style/README.md)
- **想看上下文治理（Workbench / 回望 / Semantic GC）**
  - [`docs/implementation-notes/agentmesh/workbench-state-flow.md`](docs/implementation-notes/agentmesh/workbench-state-flow.md)
- **想知道分阶段实施路线图**
  - [`docs/agentmesh/roadmap.md`](docs/agentmesh/roadmap.md)
- **想浏览整个文档树（总索引）**
...
- **Docs（解释与落地说明）**：[`docs/agentmesh/`](docs/agentmesh)
...
1) [`docs/agentmesh/execution.md`](docs/agentmesh/execution.md)
2) [`docs/agentmesh/artifacts.md`](docs/agentmesh/artifacts.md)
3) [`docs/agentmesh/subagents.md`](docs/agentmesh/subagents.md)
4) [`docs/agentmesh/adapters/codex.md`](docs/agentmesh/adapters/codex.md)
5) [`docs/agentmesh/gui.md`](docs/agentmesh/gui.md)
6) [`docs/agentmesh/roadmap.md`](docs/agentmesh/roadmap.md)
...
- [`docs/agentmesh/legacy/agentmesh-vision-proposal.md`](docs/agentmesh/legacy/agentmesh-vision-proposal.md)
