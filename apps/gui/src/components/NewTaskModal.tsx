        ...
        <div className="mb-5 flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-text-muted">
              Creates a new `.agentmesh/tasks/*` entry.
            </p>
          </div>
          <button
            type="button"
              ...
              {(["swarm", "squad"] as TaskTopology[]).map((value) => (
                <button
                  ...
                  className={[
                    ...
                    topology === value
                      ? "border-border-active bg-primary/10"
                ...
                {roster.map((row, idx) => (
                  ...
                  >
                    ...
                    <input
                      ...
                      value={row.instance}
                      onChange={(e) =>
                        updateRosterRow(row.id, "instance", e.target.value)
                      }
                    ...
                    <input
                      ...
                      value={row.agent}
                      onChange={(e) =>
                        updateRosterRow(row.id, "agent", e.target.value)
                      }
