...
现有文档中存在硬编码路径引用（例如 [`docs/implementation-notes/coco-gui-codex-style/README.md`](../../../../docs/implementation-notes/coco-gui-codex-style/README.md) 直接引用 [`apps/gui/src/components/CodexChat.tsx`](../../../../apps/gui/src/components/CodexChat.tsx)）。
