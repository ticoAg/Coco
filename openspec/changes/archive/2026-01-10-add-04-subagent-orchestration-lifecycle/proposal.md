...
## Why
`docs/agentmesh/roadmap.md` Phase 1 明确要求一个最小 orchestrator：可并发、可暂停/可恢复、可把关键状态落盘，并在 “任意一个完成” 时能通知/返回。
...
- 受影响代码（实现阶段）：`crates/agentmesh-orchestrator`、`crates/agentmesh-core`（事件/状态落盘）
