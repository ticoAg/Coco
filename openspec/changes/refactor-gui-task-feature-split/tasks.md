...
## 1. Spec
- [x] 1.1 确认本 change 为行为保持重构：不修改 `openspec/specs/*` 的既有 requirements（如需改动，拆分为独立 change）。
...
## 3. Validation
- [x] 3.1 `openspec validate refactor-gui-task-feature-split --strict`
