...
## Why
The current AgentMesh GUI renders reasoning and tool activity differently from the VSCode Codex plugin, causing mismatched block grouping and titles for identical sessions.
