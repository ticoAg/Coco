...
2) [`docs/agentmesh/README.md`](./agentmesh/README.md)：落地方案索引（执行闭环、Task Directory、Codex adapter、GUI、roadmap）
...
- [`docs/agentmesh/`](agentmesh)：AgentMesh 落地与实施文档（产物规范、实现评估、路线图）
- [`docs/implementation-notes/`](implementation-notes)：实现原理与机制笔记（按外部系统/组件归档）
  - [`docs/implementation-notes/agentmesh/`](implementation-notes/agentmesh)：AgentMesh 自身机制笔记（例如 Workbench State-Flow）
